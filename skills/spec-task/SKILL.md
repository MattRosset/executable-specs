...
Use `SPEC-TEMPLATE.md`, at the root of this plugin —
`${CLAUDE_PLUGIN_ROOT}/SPEC-TEMPLATE.md`, or
[read it here](https://github.com/MattRosset/executable-specs/blob/main/SPEC-TEMPLATE.md).
